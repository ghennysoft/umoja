...
// Full Agent Schema - Utilisation de .extend() au lieu de .merge()
export const agentSchema = agentPersonalSchema
  .extend(agentIdentificationSchema.shape)
  .extend(agentFunctionSchema.shape)
...
export type AgentPersonalInput = z.infer<typeof agentPersonalSchema>
